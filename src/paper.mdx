...
>
  <Fragment slot="title"><strong>Au</strong><strong>Ra</strong><strong>Sim</strong>: A Ray-Tracing-Based Automotive Radar Simulator for Dynamic Digital-Twin Scenarios</Fragment>

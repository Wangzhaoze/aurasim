...
title: "AuRaSim: A Ray-Tracing-Based Automotive Radar Simulator for Dynamic Digital-Twin Scenarios"
...
import RampCnnDigitalTwin from "./components/RampCnnDigitalTwin.astro";
...
import pedestriansScenario from "./assets/videos/demo/demo_parking_lot_ti1843_static_pedestrian_toward_radar_3tx4rx_20hz_5s_scenario.mp4";
import pedestriansRdmap from "./assets/videos/demo/demo_parking_lot_ti1843_static_pedestrian_toward_radar_3tx4rx_20hz_5s_rdmaps.mp4";
import pedestriansMicroDoppler from "./assets/videos/demo/demo_parking_lot_ti1843_static_pedestrian_toward_radar_3tx4rx_20hz_5s_micro_doppler.mp4";
import carsScenario from "./assets/videos/demo/demo_parking_lot_ti1843_static_car_approaching_3tx4rx_20hz_5s_scenario.mp4";
import carsRdmap from "./assets/videos/demo/demo_parking_lot_ti1843_static_car_approaching_3tx4rx_20hz_5s_rdmaps.mp4";
import carsMicroDoppler from "./assets/videos/demo/demo_parking_lot_ti1843_static_car_approaching_3tx4rx_20hz_5s_micro_doppler.mp4";

import dtReal1 from "./assets/comparisons/dt_real_1.png";
import dtSim1 from "./assets/comparisons/dt_sim_1.png";
import dtReal2 from "./assets/comparisons/dt_real_2.png";
import dtSim2 from "./assets/comparisons/dt_sim_2.png";
import dtReal3 from "./assets/comparisons/dt_real_3.png";
import dtSim3 from "./assets/comparisons/dt_sim_3.png";
import dtReal4 from "./assets/comparisons/dt_real_4.png";
import dtSim4 from "./assets/comparisons/dt_sim_4.png";

<Header
  title="AuRaSim: A Ray-Tracing-Based Automotive Radar Simulator for Dynamic Digital-Twin Scenarios"
  conference="Conference Name"
  authors={[
    { name: "Zhaoze Wang", url: "https://wangzhaoze.github.io/", notes: ["1", "3"] },
    { name: "Changxu Zhang", url: "https://example.com", notes: ["1", "3"] },
    { name: "Tai Fei", url: "https://example.com", notes: ["2"] },
    { name: "Christopher Grimm", url: "https://example.com", notes: ["1"] },
    { name: "Yi Jin", url: "https://example.com", notes: ["1"] },
    { name: "Ernst Warsitz", url: "https://example.com", notes: ["1"] },
    { name: "Claas Tebruegge", url: "https://example.com", notes: ["1"] },
    { name: "Markus Gardill", url: "https://example.com", notes: ["3"] },
  ]}
  notes={[
    { symbol: "1", text: " HELLA GmbH & Co. KGaA, Lippstadt, Germany" },
    { symbol: "2", text: " Dortmund University of Applied Sciences and Arts, Dortmund, Germany" },
    { symbol: "3", text: " Brandenburg University of Technology, Cottbus, Germany" },
  ]}
  links={[
...
>
  <Fragment slot="title"><strong>Au</strong><strong>Ra</strong><strong>Sim</strong>: A Ray-Tracing-Based <strong><u>Au</u></strong>tomotive <strong><u>Ra</u></strong>dar <strong><u>Sim</u></strong>ulator for Dynamic Digital-Twin Scenarios</Fragment>
  <Picture slot="background" src={cover} alt="" priority />
</Header>
...
<div class="grid gap-5 md:grid-cols-2">
  <div>
    <Comparison client:idle>
      <Picture slot="itemOne" src={dtReal1} alt="Real scene for digital twin comparison 1" />
      <Picture slot="itemTwo" src={dtSim1} alt="Simulated digital twin scene 1" />
    </Comparison>
  </div>
  <div>
    <Comparison client:idle>
      <Picture slot="itemOne" src={dtReal2} alt="Real scene for digital twin comparison 2" />
      <Picture slot="itemTwo" src={dtSim2} alt="Simulated digital twin scene 2" />
    </Comparison>
  </div>
  <div>
    <Comparison client:idle>
      <Picture slot="itemOne" src={dtReal3} alt="Real scene for digital twin comparison 3" />
      <Picture slot="itemTwo" src={dtSim3} alt="Simulated digital twin scene 3" />
    </Comparison>
  </div>
  <div>
    <Comparison client:idle>
      <Picture slot="itemOne" src={dtReal4} alt="Real scene for digital twin comparison 4" />
      <Picture slot="itemTwo" src={dtSim4} alt="Simulated digital twin scene 4" />
    </Comparison>
  </div>
</div>
...
<div class="not-prose my-8">
  <ModelViewer src="/aurasim/demo_ray_tracing_1.glb" alt="Interactive AuRaSim ray-tracing scene" />
</div>
...
<div class="grid gap-4 md:grid-cols-3">
  <div>
    <p class="mb-2 text-center font-medium">Scenario</p>
    <Video src={pedestriansScenario} />
  </div>
  <div>
    <p class="mb-2 text-center font-medium">Range-Doppler Map</p>
    <Video src={pedestriansRdmap} />
  </div>
  <div>
    <p class="mb-2 text-center font-medium">Micro-Doppler</p>
    <Video src={pedestriansMicroDoppler} />
  </div>
</div>
...
Wrap a visual in the `Figure` component to add a caption.
...
<Tabs defaultValue="true">
  <TabsList>
    ...
    <TabsTrigger value="diffc">Simulation</TabsTrigger>
    <TabsTrigger value="msillm">GenAI</TabsTrigger>
  </TabsList>
  <TabsContent value="true">
    <Picture src={dogsTrue} alt="Ground-truth reference image" />
  </TabsContent>
  <TabsContent value="diffc">
    <Picture src={dogsDiffc} alt="Simulation result" />
  </TabsContent>
  <TabsContent value="msillm">
    <Picture src={dogsMsillm} alt="GenAI result" />
  </TabsContent>
</Tabs>
...
<Carousel>
  <CarouselSlide>
    <Picture src={dogsTrue} alt="True photo of two running dogs side-by-side in shallow water" />
  </CarouselSlide>
  <CarouselSlide>
    <Picture src={dogsDiffc} alt="Photo of two running dogs, lossily compressed using the DiffC algorithm" />
  </CarouselSlide>
